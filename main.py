...
class autoBackUp(tk.Tk):
    ...
    def main(self):
        ...
        self.__usb_name_label['Detected'] = self.__label_entry.add_label_with_grid(self.directory_frame,f"{self.__data['usb_backup']} Not Detected!", "Open Sans Condensed", 15,'#AFDDE5',None,1,1,10,5)
    ...
    def backup_files(self,src_dir,dest_dir):
        ...
        for folder in os.listdir(src_dir):
            ...
            if os.path.isdir(source_path):
                self.log_message(f'{source_path} Copying to {destination_path}')
    ...
    def main_process(self,src_dir,usb_name):
        while self.__is_running:
                try:
                    ...
                    if usb_mount:
                        self.__usb_name_label['Detected'].config(text=f'{self.__data["usb_backup"]} Detected!')
    ...
    def help(self):
        ...
        "Reminders"
        "If you don't know the label or name of your USB, go to settings and,\n"
        "Click check usb name and it will show you the drive and label of your USB."
        )
